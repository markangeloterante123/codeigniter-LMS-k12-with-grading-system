 <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>pages/usr2/gal" class="nav-link active">
  ...
  <div style="background-image: linear-gradient(to bottom right, #FF6600, #FF9966, #FFCC99, #FFFFCC);" class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="color:white;" class="m-0">BULLETIN PAGE</h1>
            
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li style="color:white;" class="breadcrumb-item">HOME</li>
              <li style="color:white;" class="breadcrumb-item active">BULLETIN PAGE</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            <div style="background-image: linear-gradient(to right, #800000, #CC3300); "  class="card card-primary">
              <div style="background-image: linear-gradient(to bottom right, #800000, #CC3300); " class="card-header">
                <h3 class="card-title">BULLETIN PAGE</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row mt-4">
                        ...
                        ?>
                            <div class="col-sm-4">
                              <div class="position-relative" style="min-height: 180px;">
                                <img style="margin-bottom:5px; border:solid 1px white; height: 280px; width: 100%;" src="<?php echo base_url(); ?>assets/background/<?php echo $file; ?>" alt="Photo 3" class="img-fluid">
                              </div>
                            </div>                       
                        <?php } ?> 
                </div>
