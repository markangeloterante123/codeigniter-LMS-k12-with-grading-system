          ...
          <div class="col-md-8">
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <a data-toggle="modal" data-target="#modal-sm" class="btn btn-info card-title"><i class="fas fa-users"></i> Add List </h3></a>
                <a href="javascript:void(0)" class="btn btn-success class_section" style="margin-left:5px; color:white"><i class="fas fa-university"></i></a>
                <a href="javascript:void(0)"class="btn btn-warning view_list" title="View List Student" style="margin-left:5px; "><i class="fas fa-copy"></i></a>
                <a class="btn btn-danger" style="margin-left:5px; color:white" data-toggle="modal" data-target="#master_setting" title="View Class"><i class="fas fa-cog"></i></a>
...
$(document).ready(function(){ 
                  ...
                  for(i=0; i<data.length; i++){
                      html+=
                        '<div class="col-sm-4">'+
                          ...
                          '<label style="margin-left:5px;">Advicer: '+data[i].advicer+'</label>'+
                          ...
                          '</div>'+
                          '<label class="btn btn-success" style="margin-left:5px; font-size:22px;">'+data[i].section+' <a style="border:solid 1px black;" href="javascript:void(0)" class="btn btn-info view_section" data-section="'+data[i].section+'" title="View List of Student of '+data[i].section+'"><i class="fas fa-eye"></i> View</a></label>'+
                        '</div>'
                      ;                                       
                    }
                    html +='</div>';
    ...
    function item_display(){
           $.ajax({
              url:'<?=base_url()?>index.php/pages/ajax_masterlist',
              type: 'POST',
              dataType : "JSON",
              error: function() {
                      alert('Error Cart No.');
   ...
   $('#import_form').on('submit', function(event){
    event.preventDefault();
        $.ajax({
             ...
             success:function(data){
              $('#modal-sm').modal('hide');
              swal("Process Success!", "Sucessful Added Masterlist", "success");
              item_display();
              section();
             }
        })
