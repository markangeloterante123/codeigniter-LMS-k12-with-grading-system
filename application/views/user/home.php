...
<input type="hidden" name="id">
 <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>pages/usr/home" class="nav-link active">
         ...
         <li class="nav-item">
            <a href="<?php echo base_url(); ?>pages/usr2/clas" class="nav-link">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li style="color:white;" class="breadcrumb-item active">WALL</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">UPDATE INFORMATION</li>
                </ul>
              </div>
              <div class="card-body">
                    ...
                    ?>
                      ...
                      <div class="card card-primary">
                        ...
                        <div class="card-body">
                          ...
                          <hr>
                          <strong><i class="fas fa-university mr-1"></i> Course & Section</strong>
      ...
      <div class="modal fade" id="image_show">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div style="background-image: linear-gradient(to bottom right, #800000, #CC3300);" class="modal-body image_display">
                  ...
                  for(i=0; i<data.length; i++){
                      ...
                      '<div  class="user-block">'+
                        ...
                        '<span style="color:white;" class="username">'+
                          '<a >'+data[i].name+'</a>'+
                        '</span>'+
                        '<span style="color:white; font-size:16px;" class="description"><a class="text-success">'+data[i].date+'</a>: '+data[i].comment+'</span>'+
                      '</div>'+
                      '<br>'+
                      '<br>'
                      ;
