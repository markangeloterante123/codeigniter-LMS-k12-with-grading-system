      ...
      <div style="margin-top: 0px;" class="col-12 table-responsive" >
            <table style="margin-top: 0px;  border:2px solid black; position: absolute; top: 37%; left: 50%; transform: translate(-50%, -50%);" class="table table-striped">
              ...
              <tr>
                ...
                <th style="color:maroon; font-size: 18px;">3rd Quarter</th>
                <th style="color:maroon; font-size: 18px;">4th Quarter</th>
                <th style="color:maroon; font-size: 18px;">Final Grades</th>
            ...
            $.ajax({
              ...
              success: function (data) { 
                ...
                if(average >= '75'){
                   html +=
                    '<tr>'+
                      '<td colspan="4" style="color:maroon; font-size: 18px;" class="text-right"><strong> General Wiegthed Average:</strong></td>'+
